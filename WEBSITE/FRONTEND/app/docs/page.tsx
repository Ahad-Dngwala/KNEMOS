...
export default function DocsPage() {
  return (
    <main className="min-h-screen bg-[#fafafa] dark:bg-black py-24 px-6 relative text-black dark:text-white transition-colors duration-300">
      <Link href="/" className="absolute top-8 left-8 text-xs font-bold tracking-[2px] uppercase hover:text-[#888] dark:hover:text-[#aaa] transition-colors flex items-center gap-2">
        <span>←</span> Back to Home
      </Link>
      
      <div className="max-w-4xl mx-auto mt-8">
        <div className="text-center mb-16 relative">
          <h1 className="text-6xl font-[100] tracking-[-2px] font-display text-black dark:text-white mb-4">Documentation</h1>
          <div className="w-[30px] h-[30px] border border-black dark:border-white rotate-45 mx-auto"></div>
        </div>

        <div className="space-y-16">
          
          <section className="bg-white dark:bg-[#111] border border-black dark:border-[#333] p-10 transition-colors duration-300">
            <h2 className="text-3xl font-[100] tracking-[-1px] font-display mb-6">Overview</h2>
            <p className="text-sm text-[#444] dark:text-[#ccc] leading-relaxed mb-4">
          ...
          <section className="bg-[#f5f5f5] dark:bg-[#0a0a0a] border border-black dark:border-[#333] p-10 transition-colors duration-300">
            <h2 className="text-2xl font-bold tracking-[1px] uppercase mb-6">Step-by-Step Guide (For Beginners)</h2>
            <p className="text-sm text-[#444] dark:text-[#ccc] leading-relaxed mb-8">Follow these instructions to get your KNEMOS productivity system up and running in minutes, even if you don't know how to code.</p>
            
            <div className="space-y-8">
              <div className="relative pl-8 border-l-2 border-black dark:border-white">
                <div className="absolute left-[-9px] top-0 bg-black dark:bg-white text-white dark:text-black w-4 h-4 flex items-center justify-center text-[10px] font-bold rounded-full">1</div>
              ...
              <div className="relative pl-8 border-l-2 border-black dark:border-white">
                <div className="absolute left-[-9px] top-0 bg-black dark:bg-white text-white dark:text-black w-4 h-4 flex items-center justify-center text-[10px] font-bold rounded-full">2</div>
              ...
              <div className="relative pl-8 border-l-2 border-black dark:border-white">
                <div className="absolute left-[-9px] top-0 bg-black dark:bg-white text-white dark:text-black w-4 h-4 flex items-center justify-center text-[10px] font-bold rounded-full">3</div>
              ...
              <div className="relative pl-8 border-l-2 border-black dark:border-white">
                <div className="absolute left-[-9px] top-0 bg-black dark:bg-white text-white dark:text-black w-4 h-4 flex items-center justify-center text-[10px] font-bold rounded-full">4</div>
              ...
              <div className="relative pl-8 border-l-2 border-black dark:border-white">
                <div className="absolute left-[-9px] top-0 bg-black dark:bg-white text-white dark:text-black w-4 h-4 flex items-center justify-center text-[10px] font-bold rounded-full">5</div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-[#111] border border-[#E0E0E0] dark:border-[#333] p-8 hover:border-black dark:hover:border-white transition-colors">
          ...
          <section>
            <h2 className="text-2xl font-bold tracking-[1px] uppercase mb-6 border-b border-[#E0E0E0] dark:border-[#333] pb-4">AI Pipeline</h2>
            <div className="bg-black text-white p-8 space-y-6 font-mono text-sm border border-black dark:border-white">
              <div>
          ...
          <section>
            <h2 className="text-2xl font-bold tracking-[1px] uppercase mb-6 border-b border-[#E0E0E0] dark:border-[#333] pb-4">Technology Stack</h2>
            <div className="bg-white dark:bg-[#111] border border-[#E0E0E0] dark:border-[#333] overflow-hidden">
              <table className="w-full text-left text-sm">
                <tbody>
                  <tr className="border-b border-[#E0E0E0] dark:border-[#333]"><th className="p-4 bg-[#f5f5f5] dark:bg-[#0a0a0a] w-1/3 border-r border-[#E0E0E0] dark:border-[#333]">Desktop Shell</th><td className="p-4">Tauri v2 (Rust-native backend)</td></tr>
                  <tr className="border-b border-[#E0E0E0] dark:border-[#333]"><th className="p-4 bg-[#f5f5f5] dark:bg-[#0a0a0a] w-1/3 border-r border-[#E0E0E0] dark:border-[#333]">AI Backend</th><td className="p-4">FastAPI, Python 3.11, APScheduler, WebSockets</td></tr>
                  <tr className="border-b border-[#E0E0E0] dark:border-[#333]"><th className="p-4 bg-[#f5f5f5] dark:bg-[#0a0a0a] w-1/3 border-r border-[#E0E0E0] dark:border-[#333]">AI / ML</th><td className="p-4">mxbai-embed-large, HDBSCAN, Ollama + Qwen2.5</td></tr>
                  <tr className="border-b border-[#E0E0E0] dark:border-[#333]"><th className="p-4 bg-[#f5f5f5] dark:bg-[#0a0a0a] w-1/3 border-r border-[#E0E0E0] dark:border-[#333]">Vector DB & OCR</th><td className="p-4">ChromaDB, Tesseract</td></tr>
                  <tr className="border-b border-[#E0E0E0] dark:border-[#333]"><th className="p-4 bg-[#f5f5f5] dark:bg-[#0a0a0a] w-1/3 border-r border-[#E0E0E0] dark:border-[#333]">System Monitor</th><td className="p-4">pywin32, psutil, watchdog, mss</td></tr>
                  <tr><th className="p-4 bg-[#f5f5f5] dark:bg-[#0a0a0a] w-1/3 border-r border-[#E0E0E0] dark:border-[#333]">Auth & Web</th><td className="p-4">Supabase Auth, Next.js 15, TailwindCSS</td></tr>
                </tbody>
              </table>
            </div>
          </section>

          <section className="text-center p-12 bg-[#f5f5f5] dark:bg-[#0a0a0a] border border-[#E0E0E0] dark:border-[#333]">
            <h3 className="text-xl font-bold mb-4 text-black dark:text-white">Privacy First</h3>
            <p className="text-sm text-[#666] dark:text-[#999] max-w-2xl mx-auto">
